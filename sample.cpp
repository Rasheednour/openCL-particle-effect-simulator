...
const char *WINDOWTITLE = { "OpenCL/OpenGL Particle System -- Rasheed Mohammed" };
...
InitLists( )
{
	...
	// ****************************************
		...
		glColor3f( 1.0f, .0, 0. );	// 0. <= r,g,b <= 1.
		glPushMatrix( );
			glTranslatef( 0.f, -1000.f, 0.f );
			glutWireSphere( 500.f, 100, 100 );
		glPopMatrix( );
	...
	// do this for yourself...
		...
		glColor3f(0., 1.0f, 0.);	// 0. <= r,g,b <= 1.
		glPushMatrix();
		glTranslatef(0., -3000.f, 0.f);
	...
	// Third sphere
	// ****************************************
		glColor3f(0., 0., 1.0f);	// 0. <= r,g,b <= 1.
		glPushMatrix();
		glTranslatef(0., -6000.f, 0.f);
		glutWireSphere(1500.f, 100, 100);
		glPopMatrix();
